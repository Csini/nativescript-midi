...
export default class MidiInputPort extends MidiInputPortBase{
    ...
    */
    send(/* options */) {
        ...
        return Promise.reject(new NotImplementedError('android not yet supported'));
    }
}