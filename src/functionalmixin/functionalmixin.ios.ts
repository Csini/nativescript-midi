...
import FunctionalMixinBase from './functionalmixin.common';


/**
* Mixin which implements functionality that is common to MidiInputPort and MidiOutputPort.
*
...
*/
const FunctionalMixin = FunctionalMixinBase({
