...
export default class MidiDeviceManager extends Common {
    ...
    getDevices() {
        ...
        return Promise.resolve()
            .then(() => {
                ...
                this._devices = MidiDevice.parseDevices({
                    logger: this.logger,
    ...
    */
    _handleSourceAddedEvent(source) {
        ...
        let port = new MidiOutputPort({ logger: this.logger, source });
        this._addPort(port);
    }
    ...
    */
    _handleDestinationAddedEvent(destination) {
        ...
        let port = new MidiInputPort({ logger: this.logger, destination });
        this._addPort(port);
    }
